  ...
  return (
    <section className="container mx-auto px-9 py-60 flex flex-col lg:flex-row items-center gap-12 relative z-10">
      <div className="flex-1 space-y-8">
        ...
        {/* Subtitle */}
        <div className="space-y-4">
          <h2 className={`text-2xl lg:text-3xl font-semibold ${ isDark ?  "text-white" : "text-gray-800"}`}>Nosso projeto, feito para tornar o</h2>
          <h2 className={`text-2xl lg:text-3xl font-semibold ${ isDark ?  "text-white" : "text-gray-800"}`}>Braille acessível a todos.</h2>
        </div>
